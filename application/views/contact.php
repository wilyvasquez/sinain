...
<!-- //web-fonts --> 
				...
				<nav class="navbar navbar-default">
					...
					<div class="collapse navbar-collapse" id="bs-example-navbar-collapse-1"> 
						<ul class="nav navbar-nav navbar-right">
							...
							<li><a href="<?= base_url() ?>contacto" class="active">Contactanos</a></li>
						</ul> 
	...
	<div class="contact">
		<div class="container">
			<h2 class="agileits-title">Contactanos</h2>
			...
			<div class="col-md-4 w3_agile_mail_right">
				<div class="w3_agileits_mail_right_grid">
					...
					<div class="w3_agileits_mail_right_grid_pos">
						<img src="<?= base_url() ?>assets/images/t3.jpg" alt=" " class="img-responsive" />
					</div>
				</div>
