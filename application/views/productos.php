				...
				<nav class="navbar navbar-default">
					...
					<div class="collapse navbar-collapse" id="bs-example-navbar-collapse-1"> 
						<ul class="nav navbar-nav navbar-right">
							...
							<li><a href="<?= base_url() ?>productos"  class="active">Productos</a></li>
		...
		<div class="container">
			...
			<div class="col-md-6">
				<div class="wthree_single_grid1">
					<img src="<?= base_url() ?>assets/images/not found_2.png" alt="" width="300" class="img-responsive agile_single_img" />
				...
				<div class="popular-posts-grids">
					<div class="col-md-3 col-sm-3 col-xs-6 popular-posts-grid">	
						<div class="popular-posts-grid1">
							<a href="single.html"><img src="<?= base_url() ?>assets/images/not found_2.png" alt=" " class="img-responsive"></a>
