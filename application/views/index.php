...
<!-- //web-fonts --> 
	...
	<!-- banner --> 
	<div class="video jarallax" data-vide-bg="<?= base_url() ?>assets/video/spa">    
		<!-- header --> 
		<div class="w3header">
			<div class="container">
				<nav class="navbar navbar-default">
					...
					<div class="collapse navbar-collapse" id="bs-example-navbar-collapse-1"> 
						<ul class="nav navbar-nav navbar-right">
							<li><a href="<?= base_url() ?>sinai" class="active">Inicio</a></li>
				...
				<svg>
					<defs>
						<mask id="mask" x="0" y="0" width="100%" height="100%">
							...
							<text id="title1" x="50%" y="30%" dy="1em" letter-spacing="0.02em">Sinai </text>
						</mask>  
					</defs>
		...
		<div class="container"> 
			<div class="social-wthree-icons bnragile-icons">
				<ul>
					...
					<li><a href="#" class="fa fa-whatsapp icon icon-border" style="background-color: green"> </a></li>
	...
	<div class="services jarallax">
		<div class="container">
			<h3 class="agileits-title w3title2">PROFESIONALISMO</h3> 
	...
	<div class="about wthree-about">
		<div class="container"> 
			...
			<div class="about-section">
			   ...
			   <div class="col-md-5 ab-text w3-agileits">
			        <h3 class="agileits-title">MANICURE</h3> 
			...
			<div class="about-section abt-w3sec2">
				<div class="col-md-5 ab-text two w3-agileits">
					<h3 class="agileits-title">PEDICURE</h3> 
				...
				<div class="col-md-7 ab-left w3-agileits">
					<div class="grid">
						<div class="col-xs-6 abt-w3limg">
							<figure class="effect-jazz">
								<img src="<?= base_url() ?>assets/images/pedicure.jpg" alt=""/>
								<figcaption>
									<h4>Titulo<span>texto</span></h4>  
									<p>Lorem ipsum Nam libero tempore cum soluta nobis est at facere nobis.</p> 
								</figcaption>			
						...
						<div class="col-xs-6 abt-w3limg">
							<figure class="effect-jazz">
								<img src="<?= base_url() ?>assets/images/pedicure_2.jpg" alt=""/>
								<figcaption>
									<h4>Titulo<span>texto</span></h4>
									<p>Lorem ipsum Nam libero tempore cum soluta nobis est at facere nobis.</p> 
								</figcaption>			
	...
	<div class="testimonial agileits-w3layouts">
		<div class="container"> 
			<h3 class="agileits-title">Testimonios</h3> 
			<div class="sap_tabs">	
				<div id="horizontalTab" style="display: block; width: 100%; margin: 0px;">  
					<ul class="resp-tabs-list">
						<li class="resp-tab-item"><img src="<?= base_url() ?>assets/images/not found_2.png" alt=""/></li>
						<li class="resp-tab-item"><img src="<?= base_url() ?>assets/images/not found_2.png" alt=""/></li>
						<li class="resp-tab-item"><img src="<?= base_url() ?>assets/images/not found_2.png" alt=""/></li>
						<li class="resp-tab-item"><img src="<?= base_url() ?>assets/images/not found_2.png" alt=""/></li>
						<li class="resp-tab-item"><img src="<?= base_url() ?>assets/images/not found_2.png" alt=""/></li>
